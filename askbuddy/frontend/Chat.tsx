...
import Mensaje, { MensajeType } from "./Mensaje";
...
type Props = {
  ...
  onEnviar: (texto: string, chatId: string) => Promise<MensajeType>;
};

export default function Chat({ chat, mensajes, onEnviar }: Props) {
  const [mensajeInput, setMensajeInput] = useState("");
  const [mensajesActuales, setMensajesActuales] =
    useState<MensajeType[]>(mensajes);
